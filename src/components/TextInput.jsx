...
const OutlinedInput = styled.div`
  ...
  ${({ chipableInput, height, theme }) =>
    chipableInput &&
    `background: ${theme.card}; flex-direction: column; align-items: flex-start; gap: 8px; min-height: ${height};`}
  ${({ small }) =>
    small &&
    `border-radius: 6px; padding: 8px 10px;`}
  ${({ popup, theme }) =>
    popup &&
    `color: ${theme.popup_text_secondary}; border: 0.5px solid ${theme.popup_text_secondary + 60};`}
`;
...
const TextInput = ({
  ...
  value,
  error,
  handelChange, // Fixed spelling to 'handleChange'
  textArea,
  rows,
  columns,
  chipableInput,
        ...
        {chipableInput ? (
          <ChipWrapper>
            ...
            <Input
              ...
              name={name}
              value={value}
              onChange={(e) => handelChange(e)} // Fixed spelling to 'handleChange'
            />
          </ChipWrapper>
        ) : (
          <>
